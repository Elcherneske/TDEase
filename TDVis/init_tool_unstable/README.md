Hello There.\(@^0^@)/🎉
It is the demo of TDvis, a streamlit app aims to provide a simple, simple and pretty simple vision into the PTMS of top-down proteomics data.(pre-analyzed by Toppic)
...
0. 将init.bat拖动到项目文件夹之外的文件夹下
1. 下载项目代码后双击运行 `init.bat`
2. 等待自动完成以下步骤：
   - ✅ 创建 Python 虚拟环境
   - ✅ 安装所有依赖库
   - ✅ 启动本地服务器
